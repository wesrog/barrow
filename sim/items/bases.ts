...
export const BASES: Record<string, ItemBase> = {
  ...
  gnarled_staff: base({ id: "gnarled_staff", name: "Gnarled Staff", slot: "weapon", edge: "blunt", twoHanded: true, w: 1, h: 3, levelReq: 1, classReq: "witch", dmgMin: 2, dmgMax: 7 }),
  bone_wand: base({ id: "bone_wand", name: "Bone Wand", slot: "weapon", edge: "blunt", w: 1, h: 2, levelReq: 1, classReq: "witch", dmgMin: 1, dmgMax: 3 }),
  ...
  willow_wand: base({ id: "willow_wand", name: "Willow Wand", slot: "weapon", edge: "blunt", w: 1, h: 2, levelReq: 9, classReq: "witch", dmgMin: 3, dmgMax: 7 }),
  ember_staff: base({ id: "ember_staff", name: "Ember Staff", slot: "weapon", edge: "blunt", twoHanded: true, w: 1, h: 3, levelReq: 11, classReq: "witch", dmgMin: 7, dmgMax: 16 }),
  ...
  hexwood_wand: base({ id: "hexwood_wand", name: "Hexwood Wand", slot: "weapon", edge: "blunt", w: 1, h: 2, levelReq: 18, classReq: "witch", dmgMin: 7, dmgMax: 14 }),
  wyrmwood_staff: base({ id: "wyrmwood_staff", name: "Wyrmwood Staff", slot: "weapon", edge: "blunt", twoHanded: true, w: 1, h: 3, levelReq: 20, classReq: "witch", dmgMin: 13, dmgMax: 28 }),
