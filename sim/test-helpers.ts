...
import { getZone, zoneOf, type GameState, type Player, type ZoneState } from "./state";
import { createGame, joinPlayer, travel } from "./tick";
 ...
 * its markers, with a single player standing on it. Keeps sim tests on small,
